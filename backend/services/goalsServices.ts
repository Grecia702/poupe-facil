import type { CreateGoalsData, GoalsOverview, UpdateGoalsData } from '../types/goals.js'
import * as goalsModel from '../models/goalsModel.ts'
import { NotFoundError } from '../utils/errorTypes.ts'
