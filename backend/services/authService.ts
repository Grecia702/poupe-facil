...
import { CreateAccount } from '../models/accountModel.ts'
import bcrypt from 'bcrypt'
import { format } from 'date-fns';
import { generateAccessToken, generateRefreshToken } from '../utils/tokenUtils.ts';
import { z } from "zod";
import { OAuth2Client, type TokenPayload } from 'google-auth-library';
import logger from '../utils/loggerConfig.ts';
import type { AuthTokens, GooglePayload, GoogleUserData, JWTData, UserData } from "../types/auth.js";
import { UnauthorizedError, HttpError } from "../utils/errorTypes.ts";
import type { JwtPayload } from "../types/token.js";
import type { DadosBancarios } from "../types/AccountBank.js";
